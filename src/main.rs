...
const ORIGINAL_SCREEN_SIZE: Size = Size::new(280, 192);
...
const SCREEN_SIZE: Size = Size::new(320, 240);
#[cfg(feature = "memory_screen")]
const SCREEN_SIZE: Size = Size::new(400, 240);
...
fn draw_room<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
...
fn draw_left_door<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
...
fn draw_right_door<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
...
fn draw_top_door<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
...
fn draw_bottom_door<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
...
fn draw_front_door<D>(display: &mut D) -> Result<(), D::Error>
where
    D: DrawTarget<Color = Rgb565>,
{
